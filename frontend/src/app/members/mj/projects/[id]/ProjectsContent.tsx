/* CHANGE NOTE
Why: Client component for rendering Notion blocks with interactivity
What changed: Extracted block rendering from page.tsx for ISR compatibility
Behaviour/Assumptions: Receives pre-fetched content from server component
Rollback: Delete this file and restore original page.tsx
— mj
*/
